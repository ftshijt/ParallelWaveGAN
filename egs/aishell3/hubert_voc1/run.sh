...
hubert_text=/ocean/projects/cis210027p/yzhao16/ParallelWaveGAN/egs/aishell3/hubert_voc1/all_cn.txt # downloads/dump_feature_hubert9/label_km100_vctk_16k_tr_2mix_trim/all.txt
...
if [ -z "${tag}" ]; then
    expdir="exp/${train_set}_aishell3_km500_hs300_$(basename "${conf}" .yaml)" #(yiwen) change the dataset name
else
    expdir="exp/${train_set}_aishell3_km500_hs300_${tag}"
fi
